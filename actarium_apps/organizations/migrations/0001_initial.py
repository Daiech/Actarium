...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'organizations_organizations', (
            ...
            ('image_path', self.gf('libs.thumbs.ImageWithThumbsField')(name='image_path', sizes=((50, 50), (100, 100)), default='icons/org_default.jpg', max_length=100, blank=True, null=True)),
        ...
        db.create_table(u'organizations_groups', (
            ...
            ('image_path', self.gf('libs.thumbs.ImageWithThumbsField')(name='image_path', sizes=((50, 50), (100, 100)), default='icons/group_default.jpg', max_length=100, blank=True, null=True)),
        ...
        # Adding model 'OrganizationsRoles'
        db.create_table(u'organizations_organizationsroles', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal(u'organizations', ['OrganizationsRoles'])

        # Adding model 'OrganizationsUser'
        db.create_table(u'organizations_organizationsuser', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='organizationsuser_user', to=orm['auth.User'])),
            ('role', self.gf('django.db.models.fields.related.ForeignKey')(related_name='organizationsuser_role', to=orm['organizations.OrganizationsRoles'])),
            ('organization', self.gf('django.db.models.fields.related.ForeignKey')(related_name='organizationsuser_organization', to=orm['organizations.Organizations'])),
            ('is_active', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('date_added', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('date_modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal(u'organizations', ['OrganizationsUser'])

        # Adding unique constraint on 'OrganizationsUser', fields ['user', 'role', 'organization']
        db.create_unique(u'organizations_organizationsuser', ['user_id', 'role_id', 'organization_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'OrganizationsUser', fields ['user', 'role', 'organization']
        db.delete_unique(u'organizations_organizationsuser', ['user_id', 'role_id', 'organization_id'])
        ...
        # Deleting model 'OrganizationsRoles'
        db.delete_table(u'organizations_organizationsroles')

        # Deleting model 'OrganizationsUser'
        db.delete_table(u'organizations_organizationsuser')
