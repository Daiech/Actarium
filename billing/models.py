...
class Order(models.Model):
    id_order_status = models.ForeignKey(
        OrderStatus,  null=False, related_name='%(class)s_id_order_status')
...
class PriceAdvertising(models.Model):
    id_timetable = models.ForeignKey(
        Timetable,  null=False, related_name='%(class)s_id_timetable')
...
class OrderCustomization(models.Model):
    id_group = models.ForeignKey(
        Groups,  null=False, related_name='%(class)s_id_group')
    months = models.CharField(max_length=10, verbose_name="months")
    id_price_customization = models.ForeignKey(
...
class OrderTeamSize(models.Model):
    id_group = models.ForeignKey(
        Groups,  null=False, related_name='%(class)s_id_group')
    months = models.CharField(max_length=10, verbose_name="months")
    id_price_team_size = models.ForeignKey(
...
class OrderAdvertising(models.Model):
    ...
    id_price_advertising = models.ForeignKey(
...
class AdvertisingLog(models.Model):
    id_advertising_log_type = models.ForeignKey(
        AdvertisingLogType,  null=False, related_name='%(class)s_id_advertising_log_type')
    id_advertising = models.ForeignKey(
        Advertising,  null=False, related_name='%(class)s_id_advertising')
    id_group = models.ForeignKey(
        Groups,  null=False, related_name='%(class)s_id_group')
    id_user = models.ForeignKey(
        User,  null=False, related_name='%(class)s_id_user')
...
class RelCustomizationOrderExp(models.Model):
    id_order_customization = models.ForeignKey(
        OrderCustomization,  null=False, related_name='%(class)s_id_order_customization')
    id_exp_customization = models.ForeignKey(
        ExpCustomization,  null=False, related_name='%(class)s_id_exp_customization')
    date_added = models.DateTimeField(auto_now_add=True)
    date_modified = models.DateTimeField(auto_now=True)
...
class RelTeamSizeOrderExp(models.Model):
    id_order_team_size = models.ForeignKey(
        OrderTeamSize,  null=False, related_name='%(class)s_id_order_team_size')
    id_exp_team_size = models.ForeignKey(
        ExpTeamSize,  null=False, related_name='%(class)s_id_exp_team_size')
    date_added = models.DateTimeField(auto_now_add=True)
    date_modified = models.DateTimeField(auto_now=True)
...
class RelAdvertisingOrderExp(models.Model):
    id_order_advertising = models.ForeignKey(
        OrderAdvertising,  null=False, related_name='%(class)s_id_order_advertising')
    id_exp_advertising = models.ForeignKey(
        ExpAdvertising,  null=False, related_name='%(class)s_id_exp_advertising')
    date_added = models.DateTimeField(auto_now_add=True)
    date_modified = models.DateTimeField(auto_now=True)
