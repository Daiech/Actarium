...
groups_urls = patterns('',
    ...
    url(r'^(?P<slug_group>[-\w]+)/roles-for-this-minutes(?P<id_reunion>.*)', 'groups.views.rolesForMinutes', name='New minutes with reunion'),
    url(r'^(?P<slug_group>[-\w]+)/setRole', 'groups.views.setRole', name='Set Role'),
    url(r'^(?P<slug_group>[-\w]+)/set-rol-for-minute', 'groups.views.setRolForMinute', name='Set Role'),
    url(r'^(?P<slug_group>[-\w]+)/create-minutes(?P<id_reunion>.*)/(?P<slug_template>.*)', 'groups.views.newMinutes', name='New minutes with reunion'),
    url(r'^(?P<slug_group>[-\w]+)/uploadMinutes', 'groups.views.uploadMinutes', name='uploadMinutes'),
    url(r'^uploadMinutesAjax', 'groups.views.uploadMinutesAjax'),
