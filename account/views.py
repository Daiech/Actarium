...
def password_reset2(request):
        ...
        if not request.user.is_authenticated():
                ...
                return password_reset(request, template_name='account/password_reset_form.html', email_template_name= 'account/password_reset_email.html', post_reset_redirect='/account/password/reset/done/')
