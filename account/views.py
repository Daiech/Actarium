...
def password_reset2(request):
        ...
        if not request.user.is_authenticated():
                ...
                return password_reset(request, template_name='account/password_reset_form.html', email_template_name= 'account/password_reset_email.html', subject_template_name='account/password_reset_subject.txt', from_email='no-reply@actarium.com', post_reset_redirect='/account/password/reset/done/')
