...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'templates.address_css'
        db.add_column(u'groups_app_templates', 'address_css',
                      self.gf('django.db.models.fields.CharField')(default='pdfmodule/default_css4pdf.css', max_length=150),
                      keep_default=False)

        # Adding field 'templates.address_css4pdf'
        db.add_column(u'groups_app_templates', 'address_css4pdf',
                      self.gf('django.db.models.fields.CharField')(default='pdfmodule/default_css4pdf.css', max_length=150),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'templates.address_css'
        db.delete_column(u'groups_app_templates', 'address_css')

        # Deleting field 'templates.address_css4pdf'
        db.delete_column(u'groups_app_templates', 'address_css4pdf')
    ...
    models = {
        ...
        u'groups_app.templates': {
            ...
            'address_css': ('django.db.models.fields.CharField', [], {'default': "'pdfmodule/default_css4pdf.css'", 'max_length': '150'}),
