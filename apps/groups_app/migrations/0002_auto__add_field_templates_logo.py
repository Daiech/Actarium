...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'templates.logo'
        db.add_column(u'groups_app_templates', 'logo',
                      self.gf('libs.thumbs.ImageWithThumbsField')(name='logo', sizes=((110, 40), (130, 45), (200, 70)), default='img/actarium-beta.png', max_length=100, blank=True, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'templates.logo'
        db.delete_column(u'groups_app_templates', 'logo')
    ...
    models = {
        ...
        u'groups_app.templates': {
            ...
            'logo': ('libs.thumbs.ImageWithThumbsField', [], {'name': "'logo'", 'sizes': '((110, 40), (130, 45), (200, 70))', 'default': "'img/actarium-beta.png'", 'max_length': '100', 'blank': 'True', 'null': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '150'}),
